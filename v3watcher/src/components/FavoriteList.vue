<template>
  <div>
    ...
    <div class="inline-block ml-auto justify-end">
      ...
      <select class="p-1 rounded border border-gray-300 bg-white mx-4" id="rowsPerPage" v-model="currentPerPage">
...
export default {
  ...
  computed: {
    ...
    data() {
      const chunkedData = chunk(this.favoriteList, this.perPage[this.getIndexForArray(this.currentPerPage, this.perPage)])
			return {
